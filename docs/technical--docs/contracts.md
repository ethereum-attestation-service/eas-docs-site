...
The `EAS.sol` contract allows you to attest with specific schemas. [Explore the entire contract on github](https://github.com/ethereum-attestation-service/eas-contracts/blob/master/contracts/EAS.sol).
...
### Register an Attestation Schema
The `SchemaRegistry.sol` contract allows you to attest with specific schemas. [Explore the entire on github](https://github.com/ethereum-attestation-service/eas-contracts/blob/master/contracts/SchemaRegistry.sol).
